...
Nsims <- 10000 #500 #1000 #5000 # original 10000, reasonable 2500
burn <-  10000 #2000 #5000 # 2000 # 22000 # original 40000, reasonable 2500
...
repetitions <- 12 # only re-running on 12 cores because all higher cores produced results 
n.cv <- 100
