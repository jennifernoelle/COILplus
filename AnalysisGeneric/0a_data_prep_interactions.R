...
data_path <- 'RawDataGeneric/'
save_path <- 'ProcessedDataGeneric/' # Create this directory
...
#---------------------- PART B: CREATE THE ADJACENCY MATRICES -----------------#
...
# Creating focus array which indicateswhether the studies would have
