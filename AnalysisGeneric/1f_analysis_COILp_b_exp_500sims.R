# This file runs COIL 75/100 across four parallelized chains
...
date <- 'COILp_b_exp_500sims'  #'p75_A4_old_400sims_savemore'

# Where the raw data are saved: 
data_path_raw <- 'RawDataGeneric/'
# Where the processed data are saved:
data_path_processed <- 'ProcessedDataGeneric/'
# Where you want to save MCMC results:
save_path_base <- 'ResultsGeneric/' # Crete this directory
...
# Loading the data:
load(paste0(data_path_raw, 'Cu_phylo.dat'))
