...
Nsims <- 2 #0 # original 10000, reasonable 2500
thin <-  1#0 #original 40
...
#   pred_b <- apply(mcmc$Ls, c(2, 3), mean) # Why not save the interaction probs instead of the predictions?
