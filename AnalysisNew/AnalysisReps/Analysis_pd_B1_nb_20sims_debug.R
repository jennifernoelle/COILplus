...
Nsims <- 2 #10000 #500 #1000 #5000 # original 10000, reasonable 2500
thin <-  1 #10 #5 # original 40
burn <-  2 #floor(Nsims*thin*5) #5 #40000 #2000 #5000 # 2000 # 22000 # original 40000, reasonable 2500
...
pred_nb <- apply(mcmc$Ls, c(2, 3), mean)
...
res_nb <- list(all_pred = all_pred, correlations = correlations,
