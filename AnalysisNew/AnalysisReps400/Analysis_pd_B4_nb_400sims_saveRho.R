...
source(paste0(source_path, 'MCMC_function_working_saveRho.R'))
...
Nsims <- 5 #400 #10000 #500 #1000 #5000 # original 10000, reasonable 2500
...
set.seed(cc)
  ...
  # Save random pairwise probs for trace plots
